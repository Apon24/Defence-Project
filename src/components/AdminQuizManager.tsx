    ...
    return (
      <div className="flex items-center justify-center py-12">
        <div className="text-lg text-gray-600 dark:text-gray-300">
          {language === "bn" ? "প্রশ্ন লোড হচ্ছে..." : "Loading questions..."}
        </div>
      </div>
    );
  }
      ...
      {showAddForm && (
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 space-y-4">
          <h3 className="text-xl font-bold text-gray-800 dark:text-white mb-4">
            {language === "bn" ? "নতুন প্রশ্ন যোগ করুন" : "Add New Question"}
          </h3>

          <div>
            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
              {language === "bn" ? "প্রশ্নের টেক্সট *" : "Question Text *"}
            </label>
            <textarea
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
              {language === "bn"
                ? "উত্তরের অপশন (একটি সঠিক হিসেবে চিহ্নিত করুন)"
          ...
          <div className="flex items-center space-x-2">
            ...
            <label className="text-sm font-medium text-gray-700 dark:text-gray-300">
              {language === "bn"
                ? "সক্রিয় (ব্যবহারকারীদের কাছে দৃশ্যমান)"
          ...
          <div className="flex justify-end space-x-3">
            ...
            <button
              ...
              <span>
                {language === "bn" ? "প্রশ্ন সংরক্ষণ করুন" : "Save Question"}
              </span>
            </button>
          </div>
        </div>
        ...
        {questions.length === 0 ? (
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-12 text-center">
            <p className="text-gray-600 dark:text-gray-300 text-lg">
              {language === "bn"
                ? "এখনও কোনো প্রশ্ন নেই। আপনার প্রথম প্রশ্ন যোগ করুন!"
              ...
              {question.answers && (
                <div className="space-y-2">
                  <p className="text-sm font-semibold text-gray-700 dark:text-gray-300">
                    {language === "bn" ? "উত্তরের অপশন:" : "Answer Options:"}
                  </p>
