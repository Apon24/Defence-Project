  ...
  const getUserLocation = useCallback(() => {
    ...
    navigator.geolocation.getCurrentPosition(
      (position) => {
        ...
        if (latitude >= 20.5 && latitude <= 26.8 && longitude >= 88.0 && longitude <= 92.5) {
                ...
                <div className="h-[600px] relative">
                      ...
                      return (
                        <React.Fragment key={zone.id}>
                          <Circle
                            ...
                            pathOptions={{
                              color: isCompleted ? '#10b981' : `#${zone.urgencyLevel === 'critical' ? 'ef4444' :
                                zone.urgencyLevel === 'high' ? 'f97316' :
                                  zone.urgencyLevel === 'medium' ? 'eab308' : '3b82f6'
                                }`,
                              fillColor: isCompleted ? '#10b981' : `#${zone.urgencyLevel === 'critical' ? 'ef4444' :
                                zone.urgencyLevel === 'high' ? 'f97316' :
                                  zone.urgencyLevel === 'medium' ? 'eab308' : '3b82f6'
                                }`,
                            ...
                            <Popup maxWidth={350} className="custom-popup">
                              <div className="p-1">
                                <div className="flex items-start justify-between mb-3">
                                  ...
                                  <span className={`px-2 py-1 rounded-full text-xs font-bold ${zone.urgencyLevel === 'critical' ? 'bg-red-100 text-red-700' :
                  ...
                  <div className="absolute bottom-4 right-4 z-[1000]">
                    <motion.button
                      ...
                      className={`flex items-center gap-2 px-4 py-3 rounded-xl shadow-xl transition-all ${locationLoading
                    ...
                    {userLocation && !locationError && (
                      ...
                      >
                        📍 {userLocation[0].toFixed(2)}°N, {userLocation[1].toFixed(2)}°E
                      </motion.div>
                    )}
                  </div>
                </div>
